...
export function TileView({ tile, selected, onClick, testId = 'tile' }: { tile: Tile; selected?: boolean; onClick?: () => void; testId?: string | undefined }) {
  ...
  return (
    <button type="button" className={`okey-tile${selected ? ' sel' : ''}`} data-testid={testId ?? undefined}
